                ...
                XikeTheme(journalViewModel.selectedTheme, journalViewModel.selectedStyle) {
                    CompositionLocalProvider(LocalSystemActivityCallbacks provides systemActivityCallbacks) {
                        XikeApp(
                            ...
                            pendingDraftAudio = journalViewModel.pendingDraftAudio,
                            isDraftAudioSaving = journalViewModel.isDraftAudioSaving,
                            draftAudioSaveError = journalViewModel.draftAudioSaveError,
                            onDraftAudioRecorded = journalViewModel::queueDraftAudio,
                            onDraftAudioRetry = journalViewModel::retryPendingDraftAudio,
                            onDraftAudioDiscard = journalViewModel::discardPendingDraftAudio,
...
private fun XikeApp(
    ...
    pendingDraftAudio: PendingDraftAudio?,
    isDraftAudioSaving: Boolean,
    draftAudioSaveError: String?,
    onDraftAudioRecorded: (File, Long) -> Unit,
        ...
        screenStateHolder.SaveableStateProvider(screen.name) {
            when (screen) {
                AppScreen.HOME -> MomentScreen(
                    ...
                    pendingDraftAudio = pendingDraftAudio,
                    isDraftAudioSaving = isDraftAudioSaving,
                    draftAudioSaveError = draftAudioSaveError,
                    onDraftAudioRecorded = onDraftAudioRecorded,
                    onDraftAudioRetry = onDraftAudioRetry,
                    onDraftAudioDiscard = onDraftAudioDiscard,
